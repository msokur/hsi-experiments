...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self,
        ...
        self.batch_split = BatchSplit(labels_to_train=self.config.CONFIG_DATALOADER[DLK.LABELS_TO_TRAIN],
                                      dict_names=self.config.CONFIG_PREPROCESSOR[PPK.DICT_NAMES],
    ...
    def __getitem__(self, index):
        ...
        if self.config.CONFIG_TRAINER[TK.WITH_SAMPLE_WEIGHTS] and "weights" in data.keys():
