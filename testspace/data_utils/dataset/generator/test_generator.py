...
def test___len__(zarr_3d_data_dir: str):
    ...
    data_gen = GeneratorDataset(data_archive=DataArchiveZARR(), batch_paths=batch_paths, X_name=X_NAME, y_name=y_NAME,
...
def test___getitem__(data_dir: str, data_archive: DataArchive, typ: str, patch: str, idx: int, with_weights: bool,
    ...
    print(batch_paths)
    data_gen = GeneratorDataset(data_archive=data_archive, batch_paths=batch_paths, X_name=X_NAME, y_name=y_NAME,
