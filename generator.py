...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, mode, raw_npz_path, shuffled_npz_path, splitted_npz_path, log_dir, except_indexes=[], batch_size=config.BATCH_SIZE, split_factor=config.SPLIT_FACTOR):
        '''Initialization'''
