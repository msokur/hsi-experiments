...
class Tester():
    ...
    def test_ALL_images(self, save=True,
        ...
        for path_dir in self.TEST_PATHS:
            ...
            if save_stats:
                self.count_metrics(self.all_gt, self.all_predictions, 'TOTAL', folder_name, return_dice=return_dice)
                self.count_metrics(self.all_gt, self.all_predictions, 'TOTAL', folder_name, return_dice=return_dice)
...
if __name__ == "__main__":
    ...
    tester = Tester(f'cp-0020', [config.RAW_NPZ_PATH], '',
    ...
    for path in ['2019_07_15_11_33_28_', '2019_09_04_12_43_40_', '2020_05_28_15_20_27_',
                 '2019_07_12_11_15_49_']:  # , '/work/users/mi186veva/data/2020_05_28_15_20_27_SpecCube.dat', '/work/users/mi186veva/data/2019_07_12_11_15_49_SpecCube.dat', '/work/users/mi186veva/data/2020_05_15_12_43_58_SpecCube.dat']:
