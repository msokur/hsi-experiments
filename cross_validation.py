...
def postprocessing_for_one_model():
    ...
    cross_validator = get_cross_validator(# please refer to comments in cross_validators/cross_validator_postprocessing.py/CrossValidatorPostProcessing.blank_configuration() for detailed description of configuration params
                                          configuration={
