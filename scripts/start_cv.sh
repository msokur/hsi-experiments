...
python /home/sc.uni-leipzig.de/bn322dcei/hsi-experiments-BA/cross_validation.py --experiment_folder=$1 --cv_name=$2 --abbreviation=$3 --config_index=$4 --results_folder=$5
